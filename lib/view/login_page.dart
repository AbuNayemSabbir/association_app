import 'package:association_app_madraha/controller/association_controller.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Center(
                        child: Text(
                          AppUtils.appName,
                          style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: CustomColors.primaryDark),
                        ),
                      ),
                        ...
                        return CustomElevatedButton(
                          ...
                          onPressed: () async {
                            if (formKey.currentState!.validate()) {
                              ...
                              if ((emailTextEditingController.text == "Member" &&
                                      passwordTextEditingController.text == "Thikana@1122") ||
                                  (emailTextEditingController.text == "Admin" &&
                                      passwordTextEditingController.text == "Thikana@#2026#")) {
                                ...
                                Get.snackbar(AppUtils.error, AppUtils.incorrectPassword,
